                    ...
                    <tbody>
                        {
                            this.state.users.map(
                                ...
                                <tr key = {user.id}>
                                    ...
                                    <td>{user.lastName}</td>
                                    <td>{user.email}</td>
                                    <td><button type="button" className="btn btn-primary" style={{backgroundColor:"rgb(255,0,0)"}} onClick={()=> this.deleteUserByID(user.id)}>Delete User <span class="bi bi-trash-fill" 
                                    style={{fontSize: "1rem", color: "rgb(0, 0, 0)"}}></span></button></td>
                                </tr>
                                )
                        }
                    </tbody>
