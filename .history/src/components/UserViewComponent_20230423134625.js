...
class UserViewComponent extends React.Component {
    ...
    componentDidMount(prev){
      console.log("trying to retrieve users from backend (componentDidMount)"+ this.props.isLoggedIn)
      if (!this.props.isLoggedIn){
        console.log("trying to retrieve users from backend")
        UserService.getUsers().then((response) =>{
          this.setState({users: response.data})
          });
          console.log("retrieving users from backend "+UserService.getUsers().fontSize)
      }
    }
